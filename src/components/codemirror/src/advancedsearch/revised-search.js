((mod) => {
  if (typeof exports == "object" && typeof module == "object") // CommonJS
    mod(require("codemirror"), require("./advanced-dialog"));
  else if (typeof define == "function" && define.amd) // AMD
    define(["codemirror", "./advanced-dialog"], mod);
  ...
  var findDialog = `
    ...
    <div class="CodeMirror-findreplace-btn">
      ...
      <button>Find Next</button>
      <button>Close</button>
      <span class="CodeMirror-search-hint">(Use Shift-Ctrl-F (PC), Cmd-Alt-F (Mac) for Replace)</span>
    </div>
  `;
